...
player_image = pygame.image.load("player2.png")  # Sostituisci con il tuo percorso e nome del file
...
enemy_image = pygame.image.load("enemy.png")  # Sostituisci con il tuo percorso e nome del file
...
bonus_image = pygame.image.load("speed.png")  # Sostituisci con il tuo percorso e nome del file
